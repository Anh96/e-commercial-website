    ...
    function catagories(catagories){
        ...
        if(check_lengthCatagories(catas)){
            ...
            catas.forEach((cata,index)=>{
                if(index<4){
                    htmls = `
                        <a href="#all-products" class="ctPRD flex none-change-opacity txt-Black-color" data-catagory ="${cata}">
                ...
                if(index>4){
                    ...
                    htmls = `
                        <a href="#all-products" class="ctPRD font16 none-change-opacity txt-Black-color" data-catagory ="${cata}">
                            <div>${cata}</div>
                        </a>
                    `
        ...
        catas.forEach(fil=>{
            ...
            `
                <div class="shTxt flxC mgTB-8 none-change-opacity font600">
                    <dive class="txt-Capitalize h4txt">${fil}</dive>
                </div>
            `
...
//ALL Products
import {filter_products} from "../js/handleEventShopOnline.js"
function allproducts_inshop(products){
    products.forEach(prod=>{
        var x = calculator_promotion_price(prod)
        // Case: percent-sale-off >0
        if(prod.percent_saleoff>0){
            if(prod.freeship == true){
                if(prod.rating>0){
                    if(prod.quantity_sold>0){
                        htmls= 
                            `
                                <div id="sort_result_search" class="b4etd" data-catagories-inshop = "${prod.catagories_inshop}">
                                        ...
                                        <div class="bellow-grid-item-link">
                                            ...
                                            <div class="footer-sggtion">  
                                                ...
                                                <div class="ft-sggtion-block ">
                                                    ...
                                                    <div class="nbs-sggtion flx">
                                                        <div class="rating-shop-ctn">
                                                            <div class="rating-star-ctn flex"></div>
                                                        </div>
                                                        <div class="mgl-8 flex">Đã bán
                                                            <span class="number-sld mgl-8">${prod.quantity_sold}</span>
                                                        </div>
