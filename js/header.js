...
export function renderHeaderNav_base_desktop(){
    document.querySelector("header").innerHTML += `<div class="header header-PC" style="position: fixed; top: 0; left: 0; right: 0;
    ...
    `
            <div class="nav-bar-list left-nav-bar-list flex-jtfspbt">
                <div class="header-navbar-item header-item-vertical-line flex change-opacity">
                ...
                <div class="header-navbar-item header-item-vertical-line hover-show-qrcode-download flex">
                    <a class="qrcode-link-download change-opacity" href="#" target="blank">Tải ứng dụng</a>
                    ...
                    <div class="flex">Kết nối</div>
                    <a href="#" class="change-opacity flex mgLR-4">
            ...
            <ul class="nav-bar-list right-nav-bar-list flex">
                <li class="header-navbar-item hover-show-notification">
                    <div class="ic-span-notification flex">
                        ...
                        <span class="mgLR-4 flex">Thông Báo</span>
                    </div>
                    <div class="notification box_shadow">
                        <div class="completed-log_in_status_notification" style="display:none;">                                   
                        ...
                        <div class="require-complete-signIn-toseeNotification" style="display:block ;">
                            <div class="c1">
                                <div class="flex">
                            ...
                            <div class="btn-login-signup flex">
                                <a href="../page/loginform.html" class="txt-Black-color none-change-opacity">Đăng nhập</a>
                                <a href="../page/register_form.html" class="txt-Black-color none-change-opacity">Đăng ký</a>
                            </div>
                        </div>
                    </div>
                    
                </li>
                <li class="header-navbar-item change-opacity flex-jtfspbt">
                    <div class="ic flex">
                ...
                <li id="sign-in" class="header-navbar-item header-item-vertical-line flex-jtfspar">
                    <a class="font-weigh-bold" href="../page/register_form.html" target="_self">Đăng Ký</a>
                </li>
                <li id="log-in" class="header-navbar-item flex-jtfspar">
                    <a class="font-weigh-bold" href="../page/loginform.html" target="_self">Đăng Nhập</a>
                </li>
                ...
                <div class="box-search">
                    <div class="box-search-input-icon">
                        <div class="container-input-history-search">
                            <input type="text" name="search" value="" autocomplete="off" class="nav-search-input" placeholder="Tìm sản phẩm, thương hiệu, tên shop">
...
export function renderHeaderNav_homepage_mobile(){
    document.querySelector("header").innerHTML += `<div class="header_resp_onmobile"></div>`
    $(".header_resp_onmobile").innerHTML = `<div class="search-logo-cart"></div>`

    $(".search-logo-cart").innerHTML = 
    `
        <div class="box-search-input-icon flex" style="width: 85%; height: 40px; margin-left: 10px">
            ...
            <button class="search-btn flex" style="width: fit-content ;background-color: white; margin-right:4px">
        ...
        <div class="shopping-cart flex" style="width: fit-content;">
            ...
            <a href="../page/loginform.html" class="shopping-cart-link" style="display:block">
                <div>
...
// payment - cart
export function header_none_logo_input_cart(){
    document.querySelector("header").innerHTML += `<div class="header headerPC" style="position: fixed; top: 0; left: 0; right: 0;
    transform: translateZ(0); z-index: 100; height:50px; background-image: linear-gradient(0, #fe6433, #f53e28);color: var(--white-color); padding-top: 4px;">
    </div>`
    $(".header").innerHTML += `<div class="grid nav-bar-wrap-container header_resp_desktop"></div>`
    $(".header_resp_desktop").innerHTML += `
        <nav class="header-nav-bar flex-jtfspbt"></nav>
    ...
    `
            ...
            <ul class="nav-bar-list right-nav-bar-list flex">
                <li class="header-navbar-item hover-show-notification">
                    ...
                    <div class="notification box_shadow">
                        <div class="completed-log_in_status_notification" style="display:block;">                                   
                            <p class="ul-heading-txt">Thông báo mới nhận</p>
                            <ul class="list-notification">
                                <li class="detail-list-notify change-bg-viewed">
                                    <a href="" class="notification-link">
                ...
                <li  class="acc header-navbar-item none-change-opacity">
                    <div class="font-weigh-bold user">
                        <div class="flex">
                            <div class="avtUsr flex">
                                <img src="../assets/imgs/logo/epimarble-pr-1.jpg" alt="ten shop" style="" class="flex">
                            </div>
                            <div class="usname mgLR-4">fastbuy123</div>
                        </div>
                    </div>
                    <div class="more-info-acc">
                        <div class="flxC">Tài khoản của tôi</div>
                        <div class="flxC">Đơn mua</div>
                        <div class="flxC">Đăng xuất</div>
                    </div>
                </li>
            </ul>
    `
}
export function header_paymentpage_mobile(){
    document.querySelector("header").innerHTML+= "";
    document.querySelector("header").innerHTML += `<div class="header header-mobile" style="position: fixed; top: 0; left: 0; right: 0;
    transform: translateZ(0); z-index: 100; height:50px; background-color: white; color: var(--txt-primary-color-txt); padding-top: 4px;">
    </div>`
    $(".header").innerHTML += `
        <div class="mobile-search-controller">
            <div class="mobile-search-box flex-jtfspbt">
                <div class="btn-back flex mgLR-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="var(--primary-color)" class="bi bi-arrow-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
                    </svg>
                </div>
                <div class="flex txt-color-primary-color txt-UperCase currt-name-page" style="width:90%">Thanh toán</div>
            </div>
        </div>
    `
}

export function header_cartpage_mobile(){
    document.querySelector("header").innerHTML+= "";
    document.querySelector("header").innerHTML += `<div class="header header-mobile" style="position: fixed; top: 0; left: 0; right: 0;
    transform: translateZ(0); z-index: 100; height:50px; background-color: white; color: var(--txt-primary-color-txt); padding-top: 4px;">
    </div>`
    $(".header").innerHTML += `
        <div class="mobile-search-controller">
            <div class="mobile-search-box flex-jtfspbt" style="padding: 0 10px">
                <div class="btn-back flex mgLR-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="var(--primary-color)" class="bi bi-arrow-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
                    </svg>
                </div>
                <div class="flex txt-color-primary-color txt-UperCase currt-name-page" style="width:70%">Giỏ hàng</div>
                <div class="flex txt-Black-color txt-Capitalize editbtn">Sửa</div>
            </div>
        </div>
    `
